...
public final class Route {
    ...
    public static Collection<Position> getObjects(long userId, Collection<Long> deviceIds, Collection<Long> groupIds,
        ...
        for (long deviceId: ReportUtils.getDeviceList(deviceIds, groupIds)) {
            ...
            Device dev = Context.getIdentityManager().getById(deviceId);
            result.addAll(Context.getDataManager().getPositions(dev.getUniqueId()));
        }
        return result;
    }
    ...
    public static void getExcel(OutputStream outputStream,
        ...
        for (long deviceId: ReportUtils.getDeviceList(deviceIds, groupIds)) {
            ...
            Collection<Position> positions = Context.getDataManager()
                    .getPositions(dev.getUniqueId());
            DeviceReport deviceRoutes = new DeviceReport();
           // Device device = Context.getIdentityManager().getById(deviceId);
            deviceRoutes.setDeviceName(dev.getUniqueId());
